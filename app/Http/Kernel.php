...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'discussions' => \App\Http\Middleware\Discussions::class,
        ...
        'admin.discussions.categories' => \App\Http\Middleware\AdminDiscussionCategories::class,
        'admin.discussions.settings' => \App\Http\Middleware\AdminDiscussionSettings::class,
    ];
}
